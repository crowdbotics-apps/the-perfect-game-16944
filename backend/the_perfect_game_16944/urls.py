"""the_perfect_game_16944 URL Configuration
...
admin.site.site_header = "the perfect game"
admin.site.site_title = "the perfect game Admin Portal"
admin.site.index_title = "the perfect game Admin"

# swagger
schema_view = get_schema_view(
    openapi.Info(
        title="the perfect game API",
        default_version="v1",
        description="API documentation for the perfect game App",
    ),
    public=True,
